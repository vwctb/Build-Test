...
GLOBAL(void)
jpeg_stdio_src_buffer (j_decompress_ptr cinfo, unsigned char *buffer, size_t bufsize)
{
...
static void init_source_2(j_decompress_ptr cinfo)
{
}

static int fill_input_buffer_2(j_decompress_ptr cinfo)
{
    return 1;
}

static void skip_input_data_2(j_decompress_ptr cinfo, long num_bytes)
{
...
static void term_source_2(j_decompress_ptr cinfo)
{
}
...
void jpeg_memory_src(j_decompress_ptr cinfo, unsigned char const *buffer, size_t bufsize)
{
    ...
    src = (void *)cinfo->src;
    src->pub.init_source = init_source_2;
    src->pub.fill_input_buffer = fill_input_buffer_2;
    src->pub.skip_input_data = skip_input_data_2;
    src->pub.resync_to_restart = jpeg_resync_to_restart;
    src->pub.term_source = term_source_2;
